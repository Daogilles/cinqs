...
function App() {
    ...
    App.prototype.events = function() {
        ...
        $('.driver-header .account').on('click', function() {
            $('.dropdown-logo').hasClass('active') ? $('.dropdown-logo').removeClass('active') : $('.dropdown-logo').addClass('active');
        });
...
; browserify_shim__define__module__export__(typeof icheck != "undefined" ? icheck : window.icheck);
...
; browserify_shim__define__module__export__(typeof selectordie != "undefined" ? selectordie : window.selectordie);
